...
class BannedAwareTokenObtainPairSerializer(TokenObtainPairSerializer):
    """Rechaza el login si la cuenta está baneada, además de las
    comprobaciones normales de credenciales/is_active."""
...
class ThrottledTokenObtainPairView(TokenObtainPairView):
    ...
    serializer_class = BannedAwareTokenObtainPairSerializer
